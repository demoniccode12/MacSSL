...
![Proof of pulling an API request down](/images/640by480Client.png)
...
The entire PolarSSL library is not in this project _in its entirety_. The files needed for compilation are in the /PolarSSL folder. The files found in the PolarSSL repository, but not used in the project, are found in the /polarssl-repo folder. Yes, that's a complete copy of the repo, minus the folders I used. Yeah it's annoying, tell me about it.
